...
export default function Certificates () {
    ...
    const globalGapCertificate = "https://drive.google.com/file/d/194vCrKHAmbu-2qUIz25CtS2HfpCVeq-T/view?usp=drive_link"
    ...
    return (
        <div className="Certificates">
            ...
            <div className="certificates-container">
                <a href={globalGapCertificate} target="_blank" rel="noopener noreferrer">
                    <img title="Global Gap" className="certificates-imgs-link" src={icon_globalgap} alt='icon_globalgap' />
                </a>
