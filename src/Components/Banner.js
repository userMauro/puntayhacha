    ...
    return (
        <div className="Banner">
            ...
            <div className="banner-container">
                ...
                <img title="Cripps Pink / Pink Lady" className="banner-imgs" src={icon_pinklady} alt='icon_pinklady' />
                <img title="Abate Fetel" className="banner-imgs" src={icon_abatefetel} alt='icon_abatefetel' />
                <img title="Beurre D'Anjou" className="banner-imgs" src={icon_beurredanjou} alt='icon_beurredanjou' />
                <img title="Red Bartlett" className="banner-imgs" src={icon_redbartlett} alt='icon_redbartlett' />
                <img title="Packham's Triumph" className="banner-imgs" src={icon_packhamstriumph} alt='icon_packhamstriumph' />
                <img title="William's - Bartlett" className="banner-imgs" src={icon_williamsbartlett} alt='icon_williamsbartlett' />
            </div>
